	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-pull">
				...
				<form action="/send-contact" method="post" class="form-class" id="con_form">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<input type="text" name="email" placeholder="Your email" data-msg="Please enter a valid email">
							<div class="validation"></div>
